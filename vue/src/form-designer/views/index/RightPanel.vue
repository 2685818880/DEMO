...
import TreeNodeDialog from '@/form-designer/views/index/TreeNodeDialog'
import { isNumberStr } from '@/form-designer/utils/index'
import IconsDialog from './IconsDialog'
import {
  inputComponents, selectComponents, layoutComponents
} from '@/form-designer/components/generator/config'
import { saveFormConf } from '@/form-designer/utils/db'
