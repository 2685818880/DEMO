...
module.exports = {
  ...
  dev: {
    ...
    ...dev,
    assetsPublicPath: `http://${process.env.HOST ? process.env.HOST : dev.host}:${dev.port}/`,
  },
  build: {
    contextPath: CONTEXTPATH,
    // Template for index.html
    // index: path.resolve(__dirname, `../../src/main/resources/view/${MODULE}/index/index.html`),
    index: path.resolve(__dirname, '../dist/index.html'),
    // Paths
    assetsRoot: path.resolve(__dirname, '../dist'),
    assetsSubDirectory: MODULE,
